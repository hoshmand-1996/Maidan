...
<body>
  ...
  <section class="post">
   <div class="container">
   <div class="text_info">
    <h1>چۆنێتی پۆستکردن</h1>
    <p>
        هەرکەسێک ئارەزوو دەکات  (باڵندە، پەلەوەر، ئاژەڵ، ماسی) یاخوود هەر گیاندارێکی تر بفرۆشێت بەئاسانترین  ڕێگا، ئەوا ئەم ماڵپەڕە باشترین شوێنە بۆ   ئەو مەبەستە
        کەزۆرترین بینەری دەبێت. لەم  ماڵپەڕەدا پێویستە زانیارییەکانتان بنێرن لەڕێگەی پەڕەی <a href="submit_form.php">ناردنی زانیاری</a> کەئێمەش بەزووترین کات پۆستەکانتان بۆ دەکەین بێ بەرامبەر،
        وە ئەم پۆستەبۆماوەی 10 ڕۆژ دەمێنێتەوە، وەهەرکاتیک ویستت پۆستەکە بسڕیتەوە پێش ئەو 10 ڕۆژە ئەوا دەتوانن لەڕێگەی ئەو کۆدەی کەوەرتان گرتووە لەکاتی ناردنی پۆستەکەدا بیسڕنەوە لەپەڕەی <a href="how_to_delete.php">سڕینەوەی پۆست </a> 
    </p>
  </div>
   </div>
  </section>
