...
<body>
  ...
  <section class="post">
   ...
   <div class="text_info">
    <h1>دەربارە</h1>
    <p>
        ئەم ماڵپەڕە تایبەتە بە ڕیکلام بۆ هەر گیاندارێک یاخود باڵندەیەک کە دادەنرێت لەلایەن خاوەنەکەیەوە بەمەبەستی فرۆشتنی بەڕێگایەکی یاسایی، هەروەها ئەم ماڵپەڕە دروست کراوە لەلایەن ------. 
    </p>
  </div>
   </div>
  </section>
