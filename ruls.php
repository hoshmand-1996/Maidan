...
<body>
  ...
  <section class="post">
   ...
   <div class="text_info">
    <h1>یاساوڕێنمایی</h1>
    <p>
        ئەم وێبسایتە چەند یاساو ڕێنماییەک لەخۆ دەگرێت لەوانە:
    </p>
    <ol>
        <li> .دانانی ژمارەی مۆبایل یاخود پێنە بەشێوەیەکی نادرووست ڕێگەی پێنادرێت و فلتەر دەکرێت </li>
        <li>ئەم وێبسایتە بەهیچ شێوەیەک پەیوەندی بەمامەڵەکردنی کڕیار و فرۆشیارەوە نییە، واتا هەردوولایەنەکە خۆیان بەشێوەیەکی ڕاستەوخۆ مامەڵەدەکەن.</li>
    </ol>
  </div>
   </div>
  </section>
